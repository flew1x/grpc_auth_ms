...
const (
	Auth_Register_FullMethodName = "/grpc_api.Auth/Register"
	Auth_Login_FullMethodName    = "/grpc_api.Auth/Login"
	Auth_Refresh_FullMethodName  = "/grpc_api.Auth/Refresh"
	Auth_CheckJWT_FullMethodName = "/grpc_api.Auth/CheckJWT"
)
...
func (c *authClient) CheckJWT(ctx context.Context, in *CheckJWTRequest, opts ...grpc.CallOption) (*CheckJWTResponse, error) {
	...
	err := c.cc.Invoke(ctx, Auth_CheckJWT_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
